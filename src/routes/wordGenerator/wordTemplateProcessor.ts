...
export async function processTemplate(
  ...
  try {
    if (!templateId || templateId === 'default') {
      throw new Error('No template selected or using default: should use normal Word generation logic.');
    }
    let templatePath = getTemplateFilePath(templateId);
